...
function createCash() {
  if (World.frameCount % 200 == 0) {
   // Modify the positions of cash 
    var cash = createSprite(random(50,width-50),0,10,10);
...
function createDiamonds() {
  if (World.frameCount % 320 == 0) {
    ...
    var diamonds = createSprite(random(50,width-50),0,10,10);
...
function createJwellery() {
  if (World.frameCount % 410 == 0) {
    ...
    var jwellery = createSprite(random(50,width-50),0,10,10);
...
function createSword(){
  if (World.frameCount % 530 == 0) {
    ...
    var sword = createSprite(random(50,width-50),0,10,10);
